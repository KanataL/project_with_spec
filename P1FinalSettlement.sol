    ...
    P1Settlement
{
    ...
    */
     ...
     */
    //@ invariant _FINAL_SETTLEMENT_PRICE_ == \old(_FINAL_SETTLEMENT_PRICE_);
    //@ invariant _MIN_COLLATERAL_ == \old(_MIN_COLLATERAL_);
    //@ invariant _GLOBAL_INDEX_ == \old(_GLOBAL_INDEX_);
    /*
       name "withdrawFinalSettlement-correct-result";
       reverts_when _FINAL_SETTLEMENT_ENABLED_ == false;
       ensures IERC20(_TOKEN_).balanceOf(msg.sender) >= \old(ERC20(_TOKEN_).balanceOf(msg.sender));
